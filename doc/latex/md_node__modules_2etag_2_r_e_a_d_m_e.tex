\chapter{etag}
\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e}{}\label{md_node__modules_2etag_2_r_e_a_d_m_e}\index{etag@{etag}}
\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md524}%
\Hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md524}%
...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md525}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md525}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md526}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md526}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ \mbox{\hyperlink{express_2lib_2utils_8js_aa7b4b88130584154c4a863b71b8a3075}{etag}}\ =\ \mbox{\hyperlink{test-core-js_8js_a2fc998a372f1531668f7047d0878effe}{require}}(\textcolor{stringliteral}{'etag'})}

\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md527}{}\doxysubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, \mbox{[}options\mbox{]})}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md527}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{express_8js_abde3c35e3bb7e5225dd7f234c685329c}{res}}.setHeader(\textcolor{stringliteral}{'ETag'},\ \mbox{\hyperlink{express_2lib_2utils_8js_aa7b4b88130584154c4a863b71b8a3075}{etag}}(body))}

\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md528}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md528}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md529}{}\doxysubsubsubsection{\texorpdfstring{weak}{weak}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md529}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md530}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md530}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md531}{}\doxysection{\texorpdfstring{Benchmark}{Benchmark}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md531}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md532}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2etag_2_r_e_a_d_m_e_autotoc_md532}
